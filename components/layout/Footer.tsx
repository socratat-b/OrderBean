        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              Your favorite coffee shop, now at your fingertips. Order ahead and skip the line!
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/#location" className="text-gray-600 hover:text-gray-900 transition-colors">
                  Location
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              <li className="flex items-start gap-2">
                ...
                <span>123 Coffee Street<br />Manila, Philippines</span>
              </li>
              <li className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 flex-shrink-0">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                </svg>
                <a href="mailto:hello@orderbean.com" className="hover:text-gray-900 transition-colors">
                  hello@orderbean.com
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+639123456789" className="hover:text-gray-900 transition-colors">
                  +63 912 345 6789
                </a>
              </li>
            </ul>

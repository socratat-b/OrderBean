        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="order-2 lg:order-1">
            <div className="relative">
              ...
              />
              <div className="bg-card border-border absolute -right-6 -bottom-6 rounded-2xl border p-6 shadow-xl">
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Ethically sourced from the world&apos;s finest coffee
                    regions
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Roasted in small batches for maximum freshness and flavor
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-foreground font-bold">Expert Baristas</h3>
                  <p className="text-muted-foreground">
